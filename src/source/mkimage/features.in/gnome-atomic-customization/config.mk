use/gnome-atomic-customization:
	@$(call add_feature)
	@$(call add,LIVE_PACKAGES,htop fastfetch nvtop notify-send zsh zsh-completions starship bash-completion inxi openssh-server iucode_tool systemd-ssh-agent ptyxis zram-generator cryptsetup)
